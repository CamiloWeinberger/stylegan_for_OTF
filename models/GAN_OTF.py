...
class StyleGAN:
    ...
    def train(self, dataset, num_workers, epochs, batch_sizes, fade_in_percentage, logger, output,
        ...
        for current_depth in range(start_depth, self.depth):
            ...
            #data = get_data_loader(dataset, batch_size=batch_sizes[current_depth],num_workers=num_workers)
            data = DataLoader(dataset, batch_size=batch_sizes[current_depth], shuffle=True)
